...
public class MovieClient {
    ...
    public Either<ServiceError, Option<MovieDTO>> getMovie(String movieId){
        ...
        Future<Either<ServiceError,Option<MovieDTO>>> future =
                Future.of(() -> Option.of(restTemplate.getForObject(resource + movieId, MovieDTO.class)))
                .map(val -> Either.right(val));
